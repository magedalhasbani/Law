...
# ----------------------------------------------------
# إضافة CSS خاص بمربعات الإدخال لجعل الكتابة من اليمين على جميع الأجهزة
components.html("""
<style>
...
def run_main_app():
    ...
    if st.session_state.night_mode:
        components.html("""
        <style>
        body, .stApp, .st-emotion-cache-1wrcr25, .css-18e3th9, .stMarkdown, .stTextInput, .stTextArea, .stButton, .stDownloadButton, .stMetric, .stForm, .stSelectbox, .stExpander {
            background-color: #181a1b !important;
            color: #f1f1f1 !important;
        }
        .stTextInput input, .stTextArea textarea, .stSelectbox, textarea, input[type="text"] {
        ...
        /* تخصيص مربعات البحث وحوافها */
        .stTextInput, .stTextArea, .stSelectbox {
            border-radius: 10px !important;
            border: 1px solid #333 !important;
        }
        /* تخصيص ألوان رسائل التحذير والتنبيه */
