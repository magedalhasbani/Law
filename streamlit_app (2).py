...
def render_law_file_viewer(files):
    # الزر الأزرق "عرض القانون الكامل" تم حذفه
    # الآن نستخدم فقط الكود الداخلي لعرض القوانين عند الحاجة في تبويب منفصل
    ...
    if law_sel:
        ...
        for para in doc.paragraphs:
            ...
            if txt:
                law_text += txt + "\n\n"
        # --- التعديل 1: جعل النص واضح داخل مربع النص حتى لو كان معطل ---
        # --- التعديل 2: منع زر تحديد الكل، والسماح بالتضليل اليدوي فقط ---
        st.markdown("""
        <style>
